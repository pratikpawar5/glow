...
@Component({
  selector: 'app-sme-filter-side',
  templateUrl: './sme-filter-side.component.html',
  styleUrls: ['./sme-filter-side.component.css']
})
export class SmeFilterSideComponent implements OnInit {
  ...
  filter() {
    this.router.navigate([], { queryParams: { categoriesFilterParam: Array.from(this.categoryFilterParams), citiesFilterParam: Array.from(this.cityFilterParams) } });
  }
